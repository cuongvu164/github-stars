...
8. To add your statistics to your GitHub Profile README, copy and paste the
   ...
   ```md
   ![](https://raw.githubusercontent.com/cuongvu164/github-stats/master/generated/overview.svg#gh-dark-mode-only)
   ![](https://raw.githubusercontent.com/cuongvu164/github-stats/master/generated/overview.svg#gh-light-mode-only)
   ```
   ```md
